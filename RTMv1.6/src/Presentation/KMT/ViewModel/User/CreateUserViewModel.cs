                ...
                try
                {
                    switch (userOperation)
                    {
                        case UserOperation.Add:
                            ...
                            MessageLogger.LogOperation(KmtConstants.LoginUser.LoginId, string.Format("added new user {0} .", loginId));
                            break;
                        case UserOperation.Edit:
                            EditUser();
                            MessageLogger.LogOperation(KmtConstants.LoginUser.LoginId, string.Format("edited user {0} .", loginId));
                            break;
                        case UserOperation.SetAccount:
                            SetAccount();
                            MessageLogger.LogOperation(KmtConstants.LoginUser.LoginId, string.Format("setted account ."));
                            break;
                        default:
                            break;
                    }
